...
- [CSharp](./CSharp)  
    ...
    Практика 12:
    Дополнить задание, включив помимо сущности "заметка" сущность "пользователь". У одного пользователя может быть много заметок, и не может быть заметки без пользователя.
    Нужно сделать CRUD методы управления пользователями и получение всех заметок конкретного пользователя.
    </details>
