...
<details>
<summary><a href="./Java/Alternative Task. Module 2">Альтернативная задача (модуль 2)</a></summary>

Дана последовательность из 8 цифр (`98765432`). Расставить между ними арифметические знаки (`+ - * /`) или склеить, чтобы получилось 100. Реализована генерация всех 5⁷ = 78125 комбинаций через 7 вложенных циклов. Осталось: вычисление выражений с учётом приоритетов и фильтрация по значению 100.
